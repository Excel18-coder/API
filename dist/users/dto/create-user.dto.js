...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])?/, {
        message: 'Password must contain at least one lowercase letter, one uppercase letter, and one number. Special characters are optional but recommended',
    }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^\+2547\d{8}$/, {
